  ...
  <footer style={{ background: 'var(--color-dark)', color: '#fff' }}>
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '56px 24px 32px', textAlign: 'center' }}>
      ...
      <p style={{ fontSize: '15px', color: '#bbb', fontFamily: F_SANS, lineHeight: 1.8, marginBottom: '32px', textAlign: 'justify' }} data-aos="fade-in" data-aos-delay="100">
        Sobha Crescent is an ultra-luxury residential development located in the prestigious Sector 63A along Golf Course Extension Road, Gurgaon. Offering newly launched 3 &amp; 4 BHK 100% Corner Residences starting from ₹5.57 Cr*, this iconic 42-storey high-rise rises elegantly across a sprawling 12-acre low-density estate. Every home is designed to maximize natural light, cross ventilation, and uninterrupted views of the Aravali Range. Crafted by Sobha Realty — a name synonymous with precision, quality, and timely delivery — Sobha Crescent is reserved for the truly distinguished.
      </p>
    </div>
