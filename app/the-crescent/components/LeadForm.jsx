  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-1">
      ...
      <div className="flex items-start gap-2 mt-3">
        <input type="checkbox" id="privacy-lead-cr" required defaultChecked className="mt-0.5 shrink-0" style={{ accentColor: GOLD }} />
        <label htmlFor="privacy-lead-cr" className="text-xs text-gray-500 leading-relaxed cursor-pointer" style={{ fontFamily: F_SANS }}>
      ...
      <button type="submit" disabled={loading} className="btn-gold mt-4 w-full" style={{ padding: '14px', width: '80%', display: 'flex', marginLeft: 'auto', marginRight: 'auto' }}>
