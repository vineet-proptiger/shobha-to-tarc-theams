...
const locationCategories = [
  {
    ...
    items: [
      { name: 'DPS INTERNATIONAL EDGE', time: '1 Min' },
      { name: 'GOLF COURSE ROAD', time: '10 Min' },
      { name: 'RAPID METRO', time: '15 Min' },
      { name: 'DELHI JAIPUR EXPRESSWAY', time: '15 Min' },
      { name: 'DWARKA EXPRESSWAY', time: '20 Min' },
      { name: 'IGI AIRPORT', time: '45 Min' },
    ],
  },
  {
    ...
    items: [
      { name: 'AYU HEALTH HOSPITAL', time: '3 Min' },
