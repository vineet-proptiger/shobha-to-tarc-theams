...
export default function TheCrescent() {
  ...
  return (
    <main className="relative min-h-screen bg-white">
      ...
      <button
        ...
        style={{ writingMode: 'vertical-rl', textOrientation: 'mixed', letterSpacing: '2px', borderRadius: '6px 0 0 6px' }}
      >
        Enquire Now
      </button>
      ...
      <div className="sticky-bottom-bar">
        ...
        <button onClick={() => setIsOpen(true)} className="flex-1 flex items-center justify-center btn-gold !py-2 !px-0 !rounded-none">
