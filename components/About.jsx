    ...
    <section id="about" className="relative flex items-center justify-center md:justify-end overflow-hidden py-20 md:py-0" style={{ minHeight: '90vh', background: 'var(--color-cream-dark)' }}>
      ...
      "
        ...
        <p className="font-sans text-[13px] sm:text-[14px] leading-[1.9] text-text-dark text-justify mb-8">
          Sobha Crescent in Sector 63A, Gurgaon sets a new benchmark of <H>refined luxury living</H> along the prestigious Golf Course Extension Road, thoughtfully spread across a sprawling <H>12-acre estate</H>. Among the most anticipated new launch projects in Gurgaon, this Sobha Sector 63A development is designed as a rare <H>low-density residential enclave</H> featuring 4 towers with limited inventory in this premium phase launch. A <H>42-storey landmark</H> living experience, it is an iconic high-rise address where you rise above the ordinary and claim your place among the finest. Offering thoughtfully crafted luxury apartments in Gurgaon, every residence is a <H>100% corner home</H> planned to maximize natural light, cross ventilation, and uninterrupted views of the majestic <H>Aravali Range</H>.
        </p>
